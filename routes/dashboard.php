...
use App\Http\Controllers\Dashboard\Datatables\GalleryController;
use App\Http\Controllers\Dashboard\Datatables\MessagesController;
...
Route::group([
    ...
    Route::post('/sitemap', [ActionsController::class, 'sitemap'])->name('sitemap');
    Route::post('/cache-clear', [ActionsController::class, 'cacheClear'])->name('cache');
});
