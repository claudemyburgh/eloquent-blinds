...
import { ToastItem } from "../../js/Components/Notifications"
...
const QuoteForm: FC<Props> = ({ className }) => {
  ...
  return (
    <>
      ...
      <Panel className={twMerge(`my-4 md:my-6 lg:my-8 space-y-4`, className)}>
        ...
        <form onSubmit={handleSubmitForm} noValidate method={`POST`} className={"space-y-2"}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
            ...
            <div className={`col-span-2`}>
              ...
              <TextInput name={`subject`} id={`subject`} type={`text`} disabled={product?.length > 0} value={data.subject} onChange={handleInput} className={`w-full mt-2`} />
