...
const ContactSection = () => {
  ...
  return (
    <div className="wrapper @container grid grid-cols-6 my-12 gap-6">
      <header className={`flex justify-center flex-col pr-6 col-span-6 @lg:col-span-6 @5xl:col-span-2`}>
        ...
        {component !== "Frontend/Quote" && (
          <div>
            <PlainLink size={`2xl`} href={`#`} className={`border mt-4 border-secondary-600/10`}>
              Contact Us{" "}
      ...
      {contactUsers.map((details: any, index: number) => (
        <TiltItem key={index} className={`shadow-lg shadow-primary-600/40 col-span-6 @lg:col-span-6  @5xl:col-span-2`} options={{ max: 5 }}>
