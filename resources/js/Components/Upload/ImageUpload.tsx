...
import { ProgressBar, UploadCard } from "@/Components/Upload";
...
const ImageUpload = ({ model, namedRoute }: ImageProps) => {
    ...
    return (
        <>
            <div>
                <div
                    className={`relative transition my-6 border border-dashed border-gray-200 min-h-[160px] rounded-lg text-gray-200
                ${
                    isDragOver
                        ? "opacity-100 border-primary-500 shadow-lg shadow-primary-700/10 cursor-grabbing"
                ...
                >
                    ...
                    >
                        ...
                        <span>
                            <strong>Drop file to upload</strong> or{" "}
                            <u>click to select</u>
                        </span>
                    </label>
                    <input
                ...
                {model?.media && (
                    <div
                        className={`grid gap-4 md:gap-6 lg:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2`}
                    >
