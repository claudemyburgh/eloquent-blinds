...
const DatatableActionHead = ({ categories }: any) => {
  ...
  return (
    <>
      ...
      <div className={`wrapper py-4 rounded my-4 md:my-6 bg-gray-200 dark:bg-gray-800 border border-gray-300 dark:border-gray-800 text-gray-700 dark:text-gray-200`}>
