...
const ReviewStats: FC<Props> = ({ className }) => {
    return (
        <div className={className}>
            <div className="border-primary-600 border bg-gray-800 p-4 md:p-6 rounded-lg ">
                            ...
                            {reviews.counts.map((count) => (
                                ...
                                >
                                    <dt className="flex-1 flex items-center">
                                        <p className="w-3 font-medium text-gray-900 dark:text-gray-600">
                                            {count.rating}
                                    ...
                                    <dd className="ml-3 w-10 text-right tabular-nums text-sm text-gray-900 dark:text-gray-600">
                                        {Math.round(
