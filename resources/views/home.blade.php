<x-app-layout title="Blind automation, supplier and installer" description="We offer a wide range of high-quality blinds at affordable prices. Our blinds are perfect for any room in the house and will add style and function to your space.">
    ...
    <div id="learn-more" class="wrapper grid mt-24 md:mt-32 grid-cols-12  gap-8 text-gray-500 dark:text-gray-300">
        <div class="col-span-12 lg:col-span-6 relative">
            <x-ribbon text="MOST POPULAR 💖" show="true" class="card sticky top-32 md:-rotate-3 shadow-xl shadow-primary-500/10 rounded-lg p-6 border border-primary-500/20">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-500 dark:text-gray-300">
                    Discover our expansive collection of premium blinds, meticulously crafted to offer exceptional quality at affordable prices. Whether you're sprucing up a living room, bedroom, or any other space in your home, our blinds
                ...
                <p class="mt-6 text-lg leading-8 text-gray-500 dark:text-gray-300">
                    ...
                    Aluminium, Bamboo, Basswood, Honeycomb, Roller, Venetian, and Zebra Blinds, you can effortlessly find the perfect choice to suit your taste and
