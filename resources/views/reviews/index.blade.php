    ...
    <div class="wrapper pt-24 lg:pt-32 space-y-4 grid  gap-6">
        <div class="w-full relative lg:w-1/2">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-500 dark:text-gray-300">
                Discover firsthand what our valued clients have to say about us, our exceptional products, and top-notch
                service. We take immense pride in the feedback we receive, and we encourage you to hear it directly from
                those who have
