<section aria-labelledby="sale-heading" class="relative" id="section">
    <div class="md:overflow-hidden sm:pt-14 ">
        <div class="bg-gradient-to-br dark:from-gray-900/80 from-gray-50/80 dark:to-gray-950/70 to-gray-100/70 relative border-y border-gray-200 dark:border-gray-800/50">
            ...
            <div class="wrapper flex flex-col-reverse md:flex-row-reverse min-h-[300px] gap-8 py-12 ">
                <div class="flex-1 relative">
                    ...
                    <a href="{{ route('quote') }}" class="btn mt-4 btn-gradient px-6 py-4 text-white">
                        <span>Get a free quote</span>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 ml-2">
                        ...
                        <div class="md:ml-24 flex min-w-full md:min-w-max space-x-6 sm:ml-3 lg:space-x-8">
                            <div class="flex space-y-6 flex-col sm:space-x-0 sm:space-y-6 lg:space-y-8">
                                <div class="flex-shrink-0">
                                    <img loading="lazy" width="290" height="290" class="h-44 shadow-2xl rounded-global object-cover md:h-64 2xl:h-72 aspect-square" src="{{ Vite::asset('resources/img/black-blinds.webp') }}" alt="">
                                </div>

                                <div class="mt-6 flex-shrink-0 sm:mt-0">
                                    <img loading="lazy" width="290" height="290" class="h-44 shadow-2xl rounded-global object-cover md:h-64 2xl:h-72 aspect-square" src="{{ Vite::asset('resources/img/alu-blinds.webp') }}" alt="">
                                </div>

                            </div>
                            <div class="flex space-y-6 sm:-mt-20 flex-col sm:space-x-0 sm:space-y-6 lg:space-y-8">
                                <div class="flex-shrink-0">
                                    <img loading="lazy" width="290" height="290" class="h-44 shadow-2xl rounded-global object-cover md:h-64 2xl:h-72 aspect-square" src="{{ Vite::asset('resources/img/bambo-blinds.webp') }}" alt="">
                                </div>

                                <div class="mt-6 flex-shrink-0 sm:mt-0">
                                    <img loading="lazy" width="290" height="290" class="h-44 shadow-2xl rounded-global object-cover md:h-64 2xl:h-72 aspect-square" src="{{ Vite::asset('resources/img/zebra-blinds.webp') }}" alt="">
                                </div>
                            ...
                            <div class="flex space-y-6 flex-col sm:space-x-0 sm:space-y-6 lg:space-y-8">
                                <div class="flex-shrink-0">
                                    <img loading="lazy" width="290" height="290" class="h-44 shadow-2xl rounded-global object-cover md:h-64 2xl:h-72 aspect-square" src="{{ Vite::asset('resources/img/honey-blinds.webp') }}" alt="">
                                </div>
