        ...
        <div class="mx-auto relative z-20 max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <div class="relative">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('quote') }}" class="btn mt-4 btn-gradient px-3 py-2 md:px-6 md:py-4 text-white">Request
                        a free quote</a>
                    <a href="#learn-more"
                       class=" mt-4 btn-secondary btn px-3 py-2 md:px-6 md:py-4 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-100/10">Learn
                        more
                        <span class="ml-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            ...
            <mouse-spotlight class="bg-gradient-to-br block from-primary-500 to-secondary-400 p-[2px] rounded-global">
                <img width="1037" height="615" loading="eager"
                     class="w-full lg:max-w-5xl max-w-full rounded-global block"
