<headless-popover>
    ...
    >
        ...
        @elseif($link['name'] === 'Shutters')
                    <a href="{{ route('category', 'shutters') }}" class="border border-gray-300 dark:border-gray-800 rounded-global overflow-hidden relative isolate group  shadow-lg shadow-primary-500/20">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="mt-2 space-y-3 pl-4 border-l border-gray-300 dark:border-gray-800 col-span-2">
                                @foreach($category->products as $product)
                                    <a tabindex="0" href="{{ route('product', [$category,  $product]) }}" class="flex items-center justify-between group relative text-gray-700 dark:text-gray-300 hover:text-primary-500
                                                            hover:dark:text-primary-500
                                                            focus:text-primary-500 focus:dark:text-primary-500">{{
                                                            $product->title }}
                                        <span class="absolute top-1.5 bg-gray-200 dark:bg-gray-900 -left-[22px] border-2 group-hover:border-amber-500 border-gray-300 dark:border-gray-800 w-3 h-3 rounded-full
