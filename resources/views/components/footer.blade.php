...
<footer class="w-full mt-12" aria-labelledby="footer-heading">
    ...
    <mouse-spotlight
        ...
        <div aria-hidden="true"
             class="absolute w-1/2 top-0 h-[1px] left-1/3 bg-gradient-to-r from-transparent via-secondary-500 to-transparent">
            <div
            ...
            <div class="mb-6">
                ...
                <ul class="mt-4 space-y-3">
                    @foreach($categories as $category)
                        <li>
                            <a href="{{ route('categories.index', $category) }}" class="hover-underline">
                                {{$category->title}}
                            </a>
                        </li>
                    @endforeach
