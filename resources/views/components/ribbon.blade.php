    ...
    @if($show)
        <div aria-hidden="true" class="absolute h-36 aspect-square -top-2 -right-2 z-10 overflow-hidden pointer-events-none">
            ...
            <a aria-hidden="false" href="{{ $url }}"
               class="absolute bottom-0 py-2 right-0 w-square-diagonal border-b border-amber-500 bg-gradient-to-b to-amber-400 from-amber-300 font-bold text-xs tracking-wider text-amber-950 shadow-md origin-bottom-right pointer-events-auto
